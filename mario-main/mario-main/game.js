...
const goomba_morto = new Image()
goomba_morto.src = "goomba.png";

let isJumping = true
let isBig = false
const som_pulo = new Audio();
som_pulo.src = "jump.mp4";
const som_coin = new Audio();
som_coin.src = "coin.ogg";
const som_pa = new Audio();
som_pa.src = "pa.ogg";
const som_sair = new Audio();
som_sair.src = "sair.mp4";

loadRoot("https://i.imgur.com/")

loadSprite('bloco', 'M6rwarW.png')
loadSprite('goomba', 'KPO3fR9.png')
loadSprite('baloon', 'z59lNU0.png')
loadSprite('ghost', '6YV0Zas.png')
loadSprite('slime', 'c1Vj0j1.png')
...
scene("game", ({ level, score, big }) => {
    ...
    const maps = [
        ...
        [       
            ...
            '/                   x x x x           /',
            '=              =  =  =  =  =          =',
            '                 ^^  z z   z   z   z    z  zzz z zzzzzzzzzzzzzzzzz',
            '!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!',
        ],
        [
            '=                                   /',
    ...
    const levelCfg = {
        ...
        ',': [sprite('baloon'), 'dangerous'],
        '{': [sprite('slime'), 'dangerous'],
        '@': [sprite('ghost'), 'dangerous'],
